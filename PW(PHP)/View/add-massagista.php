...
<body>
    ...
    if(isset($_POST['Submit'])) {
        $ControllerMassagistas->addMassagista();       
    }
    ?>

    <form method="post" name="form1" action="">
        <center>
            <h1>Formulário - Incluir Massagistas</h1>
        </center> 
        <table width="588" border="0" align="center">
            ...
            <tr>
                ...
                <td>
                    <font size="2">
                        <input name="dataNasc" type="date" id="dataNasc" size="05" maxlength="150" class="formbutton">
                    </font>
                </td>
            </tr>
            <tr>
                <td>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">Contato:</font>
                </td>
                <td>
                    <font size="2">
                        <input name="contato" type="text" id="contato" size="05" maxlength="20" class="formbutton">
                    </font>
                </td>
            </tr>
